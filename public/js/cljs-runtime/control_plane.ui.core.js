...
var map__18396 = cljs.core.deref(control_plane.ui.core.state);
var map__18396__$1 = cljs.core.__destructure_map(map__18396);
var loading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18396__$1,new cljs.core.Keyword(null,"loading","loading",-737050189));
var health = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18396__$1,new cljs.core.Keyword(null,"health","health",-295520649));
var containers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18396__$1,new cljs.core.Keyword(null,"containers","containers",-2127048083));
var pm2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18396__$1,new cljs.core.Keyword(null,"pm2","pm2",558965668));
...
if(cljs.core.truth_(loading)){
return module$node_modules$react$index.createElement("div",({"style": ({"display": "flex", "justifyContent": "center", "alignItems": "center", "height": "100vh"})}),module$node_modules$react$index.createElement(module$node_modules$$open_hax$uxx$dist$react$src$primitives$index.Spinner,({"size": "lg"})));
} else {
...
return root.render(module$node_modules$react$index.createElement(control_plane.ui.core.App,({})));
});
