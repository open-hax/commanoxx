...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__16610_SHARP_,p2__16609_SHARP_){
return p2__16609_SHARP_.toUpperCase();
}));
...
var G__16640 = o;
helix.impl.props.goog$module$goog$object.set(G__16640,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__16789 = cljs.core.rest(m);
var G__16790 = (function (){var entry = cljs.core.first(m);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16702_SHARP_){
if(cljs.core.map_QMARK_(p1__16702_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__16702_SHARP_);
} else {
...
while(true){
if(cljs.core.seq(m)){
var G__16813 = cljs.core.rest(m);
var G__16814 = (function (){var entry = cljs.core.first(m);
...
while(true){
if(cljs.core.seq(m)){
var G__16823 = cljs.core.rest(m);
var G__16824 = (function (){var entry = cljs.core.first(m);
var k = cljs.core.key(entry);
var v = cljs.core.val(entry);
