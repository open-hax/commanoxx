shadow$provide.module$node_modules$$open_hax$uxx$node_modules$react$cjs$react_jsx_runtime_development = function(require, module, exports) {
  (function() {
    ...
    function jsxDEV(type, config, maybeKey, source, self) {
      ...
      a: {
        ...
        maybeKey = config.ref !== void 0;
      }
      maybeKey && (ref = config.ref, typeof config.ref === "string" && ReactCurrentOwner.current && self && ReactCurrentOwner.current.stateNode !== self && (maybeKey = getComponentNameFromType(ReactCurrentOwner.current.type), didWarnAboutStringRefs[maybeKey] || (error('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', 
      ...
      if (type && type.defaultProps) {
        for (propName in config = type.defaultProps, config) {
          props[propName] === void 0 && (props[propName] = config[propName]);
        }
      }
      if (key || ref) {
    ...
    function jsxWithValidation(type, props, key, isStaticChildren, source, self) {
      var validType = typeof type === "string" || typeof type === "function" || type === REACT_FRAGMENT_TYPE || type === REACT_PROFILER_TYPE || type === REACT_STRICT_MODE_TYPE || type === REACT_SUSPENSE_TYPE || type === REACT_SUSPENSE_LIST_TYPE || type === REACT_OFFSCREEN_TYPE || typeof type === "object" && type !== null && (type.$$typeof === REACT_LAZY_TYPE || type.$$typeof === REACT_MEMO_TYPE || type.$$typeof === REACT_PROVIDER_TYPE || type.$$typeof === REACT_CONTEXT_TYPE || type.$$typeof === REACT_FORWARD_REF_TYPE || 
      ...
      if (validType && (validType = props.children, validType !== void 0)) {
        if (isStaticChildren) {
      ...
      hasOwnProperty.call(props, "key") && (isStaticChildren = getComponentNameFromType(type), validType = Object.keys(props).filter(function(k) {
        return k !== "key";
      }), props = validType.length > 0 ? "{key: someKey, " + validType.join(": ..., ") + ": ...}" : "{key: someKey}", didWarnAboutKeySpread[isStaticChildren + props] || (validType = validType.length > 0 ? "{" + validType.join(": ..., ") + ": ...}" : "{}", error('A props object containing a "key" prop is being spread into JSX:\n  let props \x3d %s;\n  \x3c%s {...props} /\x3e\nReact keys must be passed directly to JSX without using spread:\n  let props \x3d %s;\n  \x3c%s key\x3d{someKey} {...props} /\x3e', 
    ...
    var React = require("module$node_modules$$open_hax$uxx$node_modules$react$index"), REACT_ELEMENT_TYPE = Symbol.for("react.element"), REACT_PORTAL_TYPE = Symbol.for("react.portal"), REACT_FRAGMENT_TYPE = Symbol.for("react.fragment"), REACT_STRICT_MODE_TYPE = Symbol.for("react.strict_mode"), REACT_PROFILER_TYPE = Symbol.for("react.profiler"), REACT_PROVIDER_TYPE = Symbol.for("react.provider"), REACT_CONTEXT_TYPE = Symbol.for("react.context"), REACT_FORWARD_REF_TYPE = Symbol.for("react.forward_ref"), 
...
//# sourceMappingURL=module$node_modules$$open_hax$uxx$node_modules$react$cjs$react_jsx_runtime_development.js.map
